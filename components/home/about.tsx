...
const AboutSection = () => {
  ...
  const renderQuotes = (): React.ReactNode => (
    <h1 ref={quoteRef} className="font-medium text-3xl sm:text-4xl md:text-6xl">
      ...
      >
        I am a passionate UX/UI Designer who bridges the gap between user needs and visual design.{" "}
      </span>
      <span
      ...
      >
        I take responsibility for crafting intuitive, user-centered experiences.
      </span>
    </h1>
  );
